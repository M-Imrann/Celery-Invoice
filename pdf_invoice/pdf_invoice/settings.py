"""
Django settings for pdf_invoice project.
...
SECRET_KEY = "django-insecure-lc#@vc+hl%8a4)i)o#56v4s^88lo)^d3lv@zm0(zy9iie&=!n&"
...
WSGI_APPLICATION = "pdf_invoice.wsgi.application"
